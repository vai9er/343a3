...
INSERT INTO 
    Studio (studio_id, name, address, manager_id) 
VALUES 
...
INSERT INTO 
    Person (person_id, name, email, phone_number, is_engineer)
VALUES 
    (1231, 'April Ludgate', 'april@email.com', '123-456-7890', FALSE);
...
INSERT INTO
    Session (studio_id, engineer_id, session_start, session_end, session_fee) 
VALUES
    (1, 5678, '2023-01-08 10:00', '2023-01-08 15:00', 1500);
-- Other sessions are inserted similarly...

-- Insert data into RecordingSegment Table
-- Segments from the first session of 'Mouse Rat'
INSERT INTO
    RecordingSegment (session_id, length_seconds, format)
VALUES
    (1, 60, 'WAV');
...
VALUES 
    (1, 1); -- Assuming segment_id 1 belongs to the first session
